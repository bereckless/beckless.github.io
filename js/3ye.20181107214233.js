...
$('.js-98').attr('src', (dpi>1) ? 'images/5-530.jpg' : 'images/5-265.jpg');
$('.js-99').attr('src', (dpi>1) ? 'images/1-530.jpg' : 'images/1-265.jpg');
...
$('.js-98').attr('src', (dpi>1) ? 'images/5-424.jpg' : 'images/5-212-1.jpg');
$('.js-99').attr('src', (dpi>1) ? 'images/1-424.jpg' : 'images/1-212-1.jpg');
...
$('.js-98').attr('src', (dpi>1) ? 'images/5-340.jpg' : 'images/5-170.jpg');
$('.js-99').attr('src', (dpi>1) ? 'images/1-340.jpg' : 'images/1-170.jpg');
...
$('.js-97').attr('src', (dpi>1) ? 'images/fen-zu-6-562.png' : 'images/fen-zu-6-281.png');
$('.js-98').attr('src', (dpi>1) ? 'images/5-212.jpg' : 'images/5-106.jpg');
$('.js-99').attr('src', (dpi>1) ? 'images/1-212.jpg' : 'images/1-106.jpg');
...
$('.js-97').attr('src', (dpi>1) ? 'images/fen-zu-6-374.png' : 'images/fen-zu-6-187.png');
$('.js-98').attr('src', (dpi>1) ? 'images/5-142.jpg' : 'images/5-71.jpg');
$('.js-99').attr('src', (dpi>1) ? 'images/1-142.jpg' : 'images/1-71.jpg');
