...
$('.js-10').attr('src', (dpi>1) ? 'images/fen-zu-6-242-1.png' : 'images/fen-zu-6-121-1.png');
$('.js-11').attr('src', (dpi>1) ? 'images/fen-zu-7-242.png' : 'images/fen-zu-7-121.png');}else if($(window).width()>=768){$('.js').attr('src', (dpi>1) ? 'images/nao-zibook-pro-222.png' : 'images/nao-zibook-pro-111.png');
...
$('.js-10').attr('src', (dpi>1) ? 'images/fen-zu-6-194-1.png' : 'images/fen-zu-6-97-1.png');
$('.js-11').attr('src', (dpi>1) ? 'images/fen-zu-7-194.png' : 'images/fen-zu-7-97.png');}else if($(window).width()>=480){$('.js').attr('src', (dpi>1) ? 'images/nao-zibook-pro-138.png' : 'images/nao-zibook-pro-69.png');
$('.js-2').attr('src', (dpi>1) ? 'images/fen-zu-12-56.png' : 'images/fen-zu-12-28.png');
$('.js-3').attr('src', (dpi>1) ? 'images/fen-zu-12-56.png' : 'images/fen-zu-12-28.png');
$('.js-4').attr('src', (dpi>1) ? 'images/fen-zu-12-56.png' : 'images/fen-zu-12-28.png');
$('.js-5').attr('src', (dpi>1) ? 'images/fen-zu-12-56.png' : 'images/fen-zu-12-28.png');
$('.js-6').attr('src', (dpi>1) ? 'images/fen-zu-2-copy-5-68.png' : 'images/fen-zu-2-copy-5-34.png');
$('.js-7').attr('src', (dpi>1) ? 'images/fen-zu-12-58.png' : 'images/fen-zu-12-29.png');
$('.js-8').attr('src', (dpi>1) ? 'images/fen-zu-12-56.png' : 'images/fen-zu-12-28.png');
$('.js-9').attr('src', (dpi>1) ? 'images/fen-zu-3-22.png' : 'images/fen-zu-3-11.png');
$('.js-10').attr('src', (dpi>1) ? 'images/fen-zu-6-122-1.png' : 'images/fen-zu-6-61-1.png');
$('.js-11').attr('src', (dpi>1) ? 'images/fen-zu-7-122.png' : 'images/fen-zu-7-61.png');}else{$('.js').attr('src', (dpi>1) ? 'images/nao-zibook-pro-92.png' : 'images/nao-zibook-pro-46.png');
...
$('.js-10').attr('src', (dpi>1) ? 'images/fen-zu-6-82-1.png' : 'images/fen-zu-6-41-1.png');
...
$('.js-57').mouseenter(function() { $.loadImages('images/fen-zu-7-316.png', function() { }) });
$('.js-57').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-57-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = 'images/fen-zu-7-316.png'; } } });
